...
/opt/spark/bin/spark-submit --jars /var/sparkdata/sparkjars/elasticsearch-hadoop-5.6.0.jar --conf spark.io.compression.codec=lz4 /var/sparkdata/src/integration_test_spark_app.py  --brokers  kafka-0.kafka:9092,kafka-1.kafka:9092,kafka-2.kafka:9092 --topic wordcount  --checkpoint /var/sparkdata/test_output/checkpoint_word_count --es_host es-single-0.es-single  --es_port 9200 --output /test_output/streaming_output/word-count
